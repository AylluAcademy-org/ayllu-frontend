...
const apiRoute = "auth/registerWallet";
 ...
 */
export const createUserWallet = async (user) => {
  try {
    const response = await axios.post(API_URL, user);
    return response.data;
  } catch (error) {
    console.error(error);
    throw error; // Lanzar el error para que pueda ser capturado en el lugar donde se llama createUserWallet
  }
};
